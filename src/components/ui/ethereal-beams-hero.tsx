...
import { forwardRef, useImperativeHandle, useEffect, useRef, useMemo, cloneElement, isValidElement, type FC, type ReactNode } from "react"
...
// ============================================================================
// BEAMS COMPONENT (3D Background) - Adapted for Sahyogi
// ============================================================================
...
function createStackedPlanesBufferGeometry(
  ...
  for (let i = 0; i < n; i++) {
    ...
    const uvXOffset = ((i * 47.123) % 300)
    const uvYOffset = ((i * 31.777) % 300)
...
// ============================================================================
// BUTTON COMPONENT (kept from original for consistency)
// ============================================================================
...
// ============================================================================
// SAHYOGI ETHEREAL BEAMS HERO - Adapted for the project
// ============================================================================
...
export default function SahyogiEtherealHero() {
  return (
    <div className="relative min-h-[calc(100vh-3rem)] w-full overflow-hidden bg-black">
      ...
      {/* Glassmorphic Navbar - Sahyogi style */}
        ...
        <div className="mx-auto max-w-5xl px-6 lg:px-8">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <div className="mb-8 inline-flex items-center rounded-full bg-white/5 backdrop-blur-xl border border-white/10 px-4 py-2 text-sm text-white/90">
              ...
              Education • Health • Defence • Productivity
            </div>

            {/* Main Headline - Adapted for Sahyogi */}
            <h1 className="mb-6 text-5xl font-bold tracking-tighter text-white sm:text-6xl lg:text-7xl">
              Documents that{" "}
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-16">
              ...
              <Button variant="outline" size="lg" className="font-semibold bg-transparent">
                <Link href="/video">Try Video Call Demo</Link>
              </Button>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 max-w-2xl mx-auto">
              ...
              <div className="text-center">
                <div className="text-3xl font-bold text-white mb-1">Decentralized</div>
